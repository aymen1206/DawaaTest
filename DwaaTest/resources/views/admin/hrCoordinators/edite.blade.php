...
@section('content')
    ...
    <h3 style="text-align: center; margin-top: 20px">تعديل بيانات    الموظف    {{$user->name}}</h3>
    <hr>
    ...
    @csrf
        <div class="col-md-6">
            <div class="form-group icon-form">
                ...
                <div class="form-inp">
                    <input type="text" name="name" class="form-control normal-text" placeholder="إسم  الموظف" value="{{$user->name}}">
            ...
            <div class="form-group icon-form">
                ...
                <div class="form-inp">
                    ...
                    id="inputPhone" pattern="^(05|5)(5|0|3|6|4|9|1|8|7)([0-9]{7})$"
                     placeholder="رقم الهاتف     50**************"   value="{{$user->phone}}">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group icon-form">
                ...
                <div class="form-inp">
                    <input type="text" name="address" class="form-control normal-text" placeholder="العنوان"  value="{{$user->address}}">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="alert alert-success" role="alert" style="text-align: center">
                    تم  تعديل بيانات الموظف   {{$user->name}}
                </div>
            </div>      
            @php    
            }
